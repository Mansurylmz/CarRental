  ...
  return (
    <div className='hero'>
        ...
        <div className='flex justify-center'>
            <motion.img initial={{translateX:200,scale:0.7}}
            animate={{translateX:0,scale:1}} transition={{duration:0.5}} src="/hero.png" alt="gri renkte bmw araba" className='object-contain' />
        </div>
    </div>
  )
}
